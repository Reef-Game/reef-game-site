...
gsap.to(".rf__butterfly__group, .angel_fish_orange_grp, .CaribbeanReefShark", {
	x: 150,
	scrollTrigger: {
...
gsap.to(".rf__ParrotFish__group .ParrotFish__odd", {
	x: 150,
	scrollTrigger: {
		trigger: ".rf__story--block",
		duration: 2, 
...
gsap.to(".rf__ParrotFish__group .ParrotFish__even", {
	x: -250,
	scrollTrigger: {
		trigger: ".rf__story--block",
		duration: 2, 
...
gsap.to(".game__hammerhead_blue-one", {
	x: 250,
	y: 60,
	scrollTrigger: {
...
gsap.to(".game__hammerhead_blue-two", {
	x: -250,
	y: 60,
	scrollTrigger: {
		trigger: ".rf__coral_reefs--block",
...
$(function() {
    $('.rf__accordion--title').click(function(j) {
        var dropDown = $(this).closest('.rf__accordion--item').find('.rf__accordion--panel');
        $(this).closest('.rf__accordion').find('.rf__accordion--panel').not(dropDown).slideUp();
      
        if ($(this).hasClass('active')) {
            $(this).removeClass('active');
        } else {
            $(this).closest('.rf__accordion').find('.rf__accordion--title.active').removeClass('active');
